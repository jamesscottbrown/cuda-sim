/* This code was obtained from http://code.google.com/p/culsoda/ and is licensed under GNU General Public License v3
...
#endif
template<typename Fex,typename Jex>
__device__ int dlsoda_(Fex f, int *neq, double *y, double *t, double *tout, int *itol, double *rtol, double *atol, int *itask, int *istate, int *iopt, double *rwork, int *lrw, int *iwork, int *liw, Jex jac, int *jt, struct cuLsodaCommonBlock *common)
{
    /* Initialized data */
...
#endif
	 //xerrwd_(msg, &c__60, 103, &c__0, &c__0, &c__0, &c__0, &c__0, &c_b62, &c_b62, (ftnlen)60);
#ifdef EMULATION_MODE
...
#endif
	 //xerrwd_(msg, &c__50, 103, &c__0, &c__2, &lenrw, lrw, &c__0, &c_b62, &c_b62, (ftnlen)60);
	 errorCode = 60;
...
#endif
    //xerrwd_(msg, &c__60, 104, &c__0, &c__0, &c__0, &c__0, &c__0, &c_b62, &c_b62, (ftnlen)60);
#ifdef EMULATION_MODE
    fprintf(stderr, "      may not be later.  Integration will proceed anyway.   \n");
#endif
    //xerrwd_(msg, &c__60, 104, &c__0, &c__0, &c__0, &c__0, &c__0, &c_b62, &c_b62, (ftnlen)60);
...
#endif
    //xerrwd_(msg, &c__50, 104, &c__0, &c__2, &leniw, liw, &c__0, &c_b62, &c_b62, (ftnlen)60);
	errorCode = 65;
...
__host__ __device__ void cuLsodaCommonBlockInit(struct cuLsodaCommonBlock *common)
{
	...
	// initialize doubles in the common block to zero
	common->CM_conit = 0.;
	common->CM_crate = 0.;
	common->CM_ccmax = 0.;
	common->CM_el0 = 0.;
